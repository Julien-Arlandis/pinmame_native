/* mixer_patched.c — copie de mixer.c avec REVERB_LENGTH=1 pour ESP32
 * Généré depuis pinmame_workspace/src/sound/mixer.c (intouchable).
 * REVERB_LENGTH 100000 → 1 : élimine 20MB de BSS (reverbBuffer). */
