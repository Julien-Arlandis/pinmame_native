/**
 * =========================================================================
 * 🎮 PINMAME WASM - APPLICATION PRINCIPALE (main.js)
 * 🏷️ VERSION : MAIN-V1.0 (SEPARATED FROM HTML)
 * =========================================================================
 * Ce fichier contient toute la logique d'interface et de communication
 * avec le worker et l'émulateur WebAssembly.
 */
