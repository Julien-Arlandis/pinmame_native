// runtime-adapter.js
// Unified entrypoint for both browser and Node.js.
...
if (isNode) {
    ...
    throw new Error('Unsupported runtime environment for runtime-adapter.js');
}

function runBrowserAdapter() {
/**
 * =========================================================================
 * 🎮 PINMAME WASM - BROWSER ADAPTER LOGIC (runtime-adapter.js)
 * 🏷️ VERSION : RUNTIME-ADAPTER-V1.0 (UNIFIED ENTRYPOINT)
 * =========================================================================
